const variables = () => {
  ...
  console.log(`Type of gender: ${typeof gender} && value : ${gender}`);
  console.log(
    `Type of evenNumber: ${typeof evenNumbers} && value : ${evenNumbers}`
  );
  console.log(`Type of g: ${typeof g} && value : ${g}`);
  console.log(`Type of j: ${typeof j} && value : ${j}`);
};

export default variables;
// created a function then exported it
